	...
	<body>
		...
		<div class="searchFlights">
			...
			<div class="query">
				...
				<?php //echo $type; ?> Outbound <?php echo $className; ?> flights from <?php echo $origin; ?> to <?php echo $destination; ?>		
		...
		<div class="searchFlights">
			...
			<div class="listItem">
				...
				<form action="returnTripInboundFlightSearch.php" method="POST">
