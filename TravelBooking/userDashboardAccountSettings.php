...
<html lang="en">
	...
	<head>
		...
		<title>Dashboard |TravelWale</title>
			...
			<div class="col-sm-7 containerBoxRight text-left">
				...
				<div class="col-sm-12 settings">
					...
					<div class="col-sm-6 settingsWrapper warning">
						Please note that deleting an account is irreversible. If you delete an account, you will lose access to all the data and E-tickets asociated with that account. Proceed with caution.
					</div>
