...
<html lang="en">
	...
	<head>
		...
		<link rel="shortcut icon" href="images/icons/icon.jpeg">
	
		<title>Contact Us | TravelWale</title>
	...
	<body>
		...
		<div class="col-sm-5 contactUsExtras">
			...
			<div class="col-sm-12 heading">
				...
				3rd floor,gayatri boys hostel,peddaRushikonda-530045,vishakaptnam
			
			</div>
		
			<div class="col-sm-12 mapImage">
				
				<img src="images/map/map.png" alt="map" class="mapDim"/>
