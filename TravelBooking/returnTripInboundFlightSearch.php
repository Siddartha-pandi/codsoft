...
<html lang="en">
	...
	<head>
		...
		<title>Flight Search |TravelWale</title>
	...
	<body>
		...
		<div class="searchFlights">
			...
			<div class="query">
				...
				<?php //echo $type; ?> Inbound <?php echo $className; ?> flights from <?php echo $destination; ?> to <?php echo $origin; ?>		
		...
		<?php
			...
			$sql = "SELECT * FROM flights WHERE origin='$destination' AND destination='$origin' AND class='$className' ORDER BY seats_available DESC";
		...
		<div class="searchFlights">
			...
			<div class="listItem">
				...
				<input type="hidden" name="flightNoInboundHidden" value="<?php echo $row["flight_no"]; ?>">
